...
@MappedSuperclass
public abstract class AbstractBaseEntityOld implements Persistable<UUID>, Serializable, IUuidBaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbstractBaseEntityOld)) return false;
        AbstractBaseEntityOld that = (AbstractBaseEntityOld) o;
