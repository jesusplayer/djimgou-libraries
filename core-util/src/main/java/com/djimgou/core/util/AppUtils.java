...
//        String r2 = sdf.format(date);
   ...
   /* public static List<Field> getFields(Class classe, Predicate<Field> predicate) {
    ...
    public static Class getGenericParamTypeFromClass(Class classe, int pos) {
        ParameterizedType pt = (ParameterizedType) classe.getGenericSuperclass();
        Class cc = null;
    ...
    public static List<Type> getGenericParamTypeFromInterface(Class classe) {
        ((ParameterizedType) classe.getGenericInterfaces()[0]).getActualTypeArguments();
        List<Type> list = Arrays.asList(classe.getGenericInterfaces()).stream()
    ...
    public static Class getGenericParamTypeFromInterface(Class classe, int pos) {
