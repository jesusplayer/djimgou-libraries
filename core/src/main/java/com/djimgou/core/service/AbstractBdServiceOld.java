...
@Log4j2
public abstract class AbstractBdServiceOld<T extends IUuidBaseEntity> implements ISharedService<T>, Serializable {
    @PersistenceContext
    EntityManager em;
    ...
    public AbstractBdServiceOld() {
    }

    public AbstractBdServiceOld(JpaRepository<T, UUID> repo) {
        this.repo = repo;
    }
