...
package com.djimgou.core.testing.app;
...
@EntityScan(basePackages = {"com.djimgou.core.testing.app.model"})
@EnableJpaRepositories(basePackages = {"com.djimgou.core"})
@SpringBootApplication(scanBasePackages = {"com.djimgou.core"}
...
public class MaincoreTestApplication {
