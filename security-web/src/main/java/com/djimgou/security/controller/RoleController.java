...
public class RoleController {
    ...
    public Role create(@RequestBody @Valid RoleDto roleDto) throws NotFoundException, BadRequestException, ConflitException {
    ...
    public Role update(
            @PathVariable("roleId") final UUID id, @RequestBody @Valid final RoleDto roleDto) throws NotFoundException, BadRequestException, ConflitException {
